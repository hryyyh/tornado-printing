    ...
    <div id="heroCarousel"
        ...
        <div class="carousel-inner rounded-4 overflow-hidden">
            ...
            <div class="carousel-item active">
                <img src="<?php echo e(asset('images/tamu/banner1.png')); ?>"
                     class="d-block w-100">
            </div>

            <div class="carousel-item">
                <img src="<?php echo e(asset('images/tamu/banner2.png')); ?>"
                     class="d-block w-100">
            </div>

            <div class="carousel-item">
                <img src="<?php echo e(asset('images/tamu/banner3.png')); ?>"
                     class="d-block w-100">
            </div>

            <div class="carousel-item">
                <img src="<?php echo e(asset('images/tamu/banner4.png')); ?>"
                     class="d-block w-100">
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mb-4 mb-md-0 text-center">
                <img src="<?php echo e(asset('images/tamu/body.jpg')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\laravel\Tornado_Printing\resources\views/pages/home.blade.php ENDPATH**/ ?>